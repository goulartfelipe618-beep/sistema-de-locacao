...
NAVIGATION: tuple[MenuSection, ...] = (
    ...
    MenuSection(
        ...
        icon="car",
        items=(
            MenuItem("Veículos", url="/frota/veiculos"),
            MenuItem("Categorias", url="/frota/categorias"),
            MenuItem("Marcas", url="/frota/marcas"),
            MenuItem("Modelos", url="/frota/modelos"),
            MenuItem("Combustíveis", url="/frota/combustiveis"),
            MenuItem("Acessórios", url="/frota/acessorios"),
            MenuItem("Documentação", url="/frota/documentacao"),
            MenuItem("Telemetria", url="/frota/telemetria"),
        ),
    ),
    MenuSection(
        label="Manutenção",
